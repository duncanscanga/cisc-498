...
def displayPosters(indexes):
	...
	ttk.Button(win, text= movies[index1]['title'] + ' (' +  movies[index1]['year'] + ')', command=  lambda i = indexes : firstMovieChosen(i) ).pack(in_=top, side=LEFT)
	...
	ttk.Button(win, text= movies[index2]['title'] + ' (' +  movies[index2]['year'] + ')', command=lambda i = indexes : secondMovieChosen(i)).pack(in_=top, side=LEFT)
